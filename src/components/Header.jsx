...
function Header() {
    ...
    return (
        <>
            <header className={`site-header ${hidden ? 'header-hidden' : ''} ${scrolled ? 'header-scrolled' : ''}`}>
                <div className="announcement-bar-wrapper">
                    <a href="#" className="announcement-bar">
                        <div className="announcement-mobile">
                            🚨 The Category Leaderboard - Live Now
                        </div>
                        <div className="announcement-desktop">
                            <div className="text-normal">🚨 The Category Leaderboard - Live Now</div>
                            <div className="text-hover">🚨 The Category Leaderboard - Live Now</div>
                        </div>
                    </a>
                </div>
                ...
                <div className="header-main">
                    <a href="#" className="logo">
                        <svg className="logo-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 168 21" fill="currentColor">
                    ...
                    <nav className="desktop-nav">
                        <ul className="nav-links">
                            ...
                            <li><a href="#" className="nav-link">Work <span className="nav-badge">25</span></a></li>
                            <li><a href="#" className="nav-link">Careers</a></li>
                            <li><a href="#" className="nav-link">Blog</a></li>
                            <li><a href="#" className="nav-link">Webinar</a></li>
                        </ul>
                    </nav>
