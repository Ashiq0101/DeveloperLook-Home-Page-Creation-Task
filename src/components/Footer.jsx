            ...
            <div className="footer-content">
                <div className="footer-top-row">
                    <div className="footer-left-col">
                        <h2 className="footer-heading">Stay updated with Rise news</h2>
                        ...
                        <div className="social-links">
                            <a href="https://www.facebook.com/riseatseven" target="_blank" rel="noreferrer" className="social-link">
                                <i className="fa-brands fa-facebook-f"></i>
                                <svg width="10" height="10" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 13L13 1M13 1V10M13 1H4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
                            </a>
                            <a href="https://x.com/riseatseven" target="_blank" rel="noreferrer" className="social-link">
                                <i className="fa-brands fa-x-twitter"></i>
                                <svg width="10" height="10" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 13L13 1M13 1V10M13 1H4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
                            </a>
                            <a href="https://www.linkedin.com/company/riseatseven/" target="_blank" rel="noreferrer" className="social-link">
                                <i className="fa-brands fa-linkedin-in"></i>
                                <svg width="10" height="10" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 13L13 1M13 1V10M13 1H4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
                            </a>
                            <a href="https://www.youtube.com/channel/UCAjOP9BgpZPTgae-QT9HGCw" target="_blank" rel="noreferrer" className="social-link">
                                <i className="fa-brands fa-youtube"></i>
                                <svg width="10" height="10" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 13L13 1M13 1V10M13 1H4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
                            </a>
                            <a href="https://www.tiktok.com/@riseatseven" target="_blank" rel="noreferrer" className="social-link">
                                <i className="fa-brands fa-tiktok"></i>
                                <svg width="10" height="10" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M1 13L13 1M13 1V10M13 1H4" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/></svg>
                            </a>
                            <a href="https://www.instagram.com/riseatseven/" target="_blank" rel="noreferrer" className="social-link">
                    ...
                    <div className="footer-right-col">
                        <div className="footer-nav-col">
                            <a href="#" className="footer-nav-link"><span data-text="Services">Services</span></a>
                            <a href="#" className="footer-nav-link"><span data-text="Work">Work</span></a>
                            <a href="#" className="footer-nav-link"><span data-text="About">About</span></a>
                            <a href="#" className="footer-nav-link"><span data-text="Culture">Culture</span></a>
                            <a href="#" className="footer-nav-link"><span data-text="Meet The Risers">Meet The Risers</span></a>
                        </div>
                        <div className="footer-nav-col">
                            <a href="#" className="footer-nav-link"><span data-text="Testimonials">Testimonials</span></a>
                            <a href="#" className="footer-nav-link"><span data-text="Blog &amp; Resources">Blog &amp; Resources</span></a>
                            <a href="#" className="footer-nav-link"><span data-text="Webinars">Webinars</span></a>
                            <a href="#" className="footer-nav-link"><span data-text="Careers">Careers</span></a>
                        </div>
                        <div className="footer-nav-col">
                            <a href="#" className="footer-nav-link"><span data-text="Sheffield">Sheffield</span></a>
                            <a href="#" className="footer-nav-link"><span data-text="Manchester">Manchester</span></a>
                            <a href="#" className="footer-nav-link"><span data-text="London">London</span></a>
                            <a href="#" className="footer-nav-link"><span data-text="New York">New York</span></a>
                            <a href="#" className="footer-nav-link"><span data-text="Contact">Contact</span></a>
                        </div>
                    </div>
                </div>

                <div className="footer-logo-container">
                    <svg className="footer-logo-svg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 168 21" fill="none">
                        <path d="M91.3152 5.40061C91.3152 3.94241 92.5306 2.67359 93.9881 2.67359C95.7162 2.67359 96.797 3.83419 96.797 5.56225H99.7127C99.7127 2.1873 97.3096 0 93.9874 0C90.9371 0 88.3988 2.32257 88.3988 5.42766C88.3988 9.31596 90.883 10.2344 93.9874 11.4221C95.6627 12.07 97.2007 12.5563 97.2007 14.6895C97.2007 16.634 95.9867 18.0651 93.9874 18.0651C91.8813 18.0651 90.7477 16.3905 90.7477 14.446H87.832C87.832 18.0651 90.3426 20.7381 93.9874 20.7381C97.6323 20.7381 100.118 18.2816 100.118 14.6895C100.118 7.10161 91.3145 9.64061 91.3145 5.40061H91.3152Z" fill="currentColor"></path>
                        <path d="M109.209 4.99609C104.834 4.99609 101.539 8.53405 101.539 12.8539C101.539 17.1737 104.888 20.738 109.155 20.738C112.422 20.738 115.203 18.713 116.337 15.662H113.529C112.718 17.2278 111.017 18.1733 109.262 18.1733C106.806 18.1733 104.915 16.4182 104.348 14.0963H116.743C116.797 13.6371 116.823 13.1508 116.823 12.6922C116.823 8.47926 113.447 4.99609 109.209 4.99609ZM104.348 11.9361C104.509 9.47823 106.751 7.56147 109.181 7.56147C111.611 7.56147 113.853 9.47823 114.014 11.9361H104.348Z" fill="currentColor"></path>
                        <path d="M127.476 5.40039L123.575 16.0941L119.673 5.40039H116.676L122.617 20.3598H124.588L130.475 5.40039H127.476Z" fill="currentColor"></path>
                        <path d="M137.942 4.99609C133.567 4.99609 130.273 8.53405 130.273 12.8539C130.273 17.1737 133.621 20.738 137.888 20.738C141.155 20.738 143.936 18.713 145.071 15.662H142.262C141.453 17.2278 139.75 18.1733 137.996 18.1733C135.538 18.1733 133.649 16.4182 133.081 14.0963H145.476C145.53 13.6371 145.556 13.1508 145.556 12.6922C145.556 8.47926 142.182 4.99609 137.942 4.99609ZM133.081 11.9361C133.243 9.47823 135.484 7.56147 137.915 7.56147C140.347 7.56147 142.586 9.47823 142.749 11.9361H133.081Z" fill="currentColor"></path>
                        <path d="M147.473 8.21195V8.69013V20.3618H150.032V10.1815L167.216 20.3618V17.2405L147.473 5.40039V8.21195Z" fill="currentColor"></path>
                        <path d="M67.8431 7.50804H67.789C66.6818 5.80635 64.7103 4.99609 62.713 4.99609C58.1775 4.99609 54.7734 8.3981 54.7734 12.935C54.7734 17.4719 58.2296 20.7387 62.713 20.7387C64.7651 20.7387 66.7359 19.8473 67.789 18.0387H67.8431V20.3606H70.652V5.40122H67.8431V7.50804ZM62.686 18.1733C59.823 18.1733 57.5823 15.7168 57.5823 12.9073C57.5823 10.0978 59.7425 7.56079 62.7124 7.56079C65.6822 7.56079 67.8972 9.90973 67.8972 12.9073C67.8972 15.9048 65.6024 18.1733 62.6867 18.1733H62.686Z" fill="currentColor"></path>
                        <path d="M77.5832 0.378906H74.7736V5.40144H72.75V7.96681H74.7736V20.3608H77.5832V7.96681H80.0403V5.40144H77.5832V0.378906Z" fill="currentColor"></path>
                        <path d="M18.3089 0.378906H15.5V3.2953H18.3089V0.378906Z" fill="currentColor"></path>
                        <path d="M18.3089 5.02344H15.5V19.9828H18.3089V5.02344Z" fill="currentColor"></path>
                ...
                <div className="footer-bottom-row">
                    ...
                    <div className="footer-credit">
                        <a href="https://madebyshape.co.uk" target="_blank" rel="noopener noreferrer">Website MadeByShape</a>
                    </div>
                </div>
            </div>
        </footer>
